...
/*cyj begin */
int MediaMetadataRetriever::getScaledFrameAtTime2(int64_t timeUs, int option, VideoFrame *frm, int width, int height)
{
    Mutex::Autolock _l(mLock);
    return ::get_scaled_frame_at_time2(&state, timeUs, option, frm, width, height);
}
/* cyj end */
